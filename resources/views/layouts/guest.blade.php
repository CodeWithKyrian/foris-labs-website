    ...
    <div class="font-sans text-ash-900 antialiased">
        ...
        <section class="text-ash-400 bg-ash-800 body-font">
            <div class="container px-5 py-16 mx-auto flex flex-wrap items-center">
                ...
                <form action="{{route('register-affiliate')}}" method="POST" class="lg:w-2/6 md:w-1/2 bg-ash-700 bg-opacity-50 rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0">
                    @csrf
                    ...
                    <div class="relative mb-4">
                        ...
                        <input type="text" required id="name" name="name" class="w-full bg-ash-600 bg-opacity-20 focus:bg-transparent focus:ring-1 focus:ring-orange-600 rounded border border-ash-600 focus:border-orange-200 text-base outline-none text-ash-100 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                    </div>
                    <div class="relative mb-4">
                        <label for="email" class="leading-7 text-sm text-ash-400">Email</label>
                        <input type="email" required id="email" name="email" class="w-full bg-ash-600 bg-opacity-20 focus:bg-transparent focus:ring-1 focus:ring-orange-600 rounded border border-ash-600 focus:border-orange-200 text-base outline-none text-ash-100 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                    </div>
