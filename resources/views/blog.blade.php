<x-blog-layout>
    <section class="text-ash-600 bg-ash-100 body-font pt-8">
        <div class="container px-5 lg:px-12 py-16 mx-auto">
            <x-title color="dark">News and Events</x-title>
            <ul class="flex flex-wrap -mx-2 overflow-hidden">
                @foreach($featured as $post)
                <li class="my-2 px-2 w-full overflow-hidden md:w-1/2">
                    <a href="/blog/{{ $post->slug }}">
                        <div class="mx-2 flex items-center justify-center bg-gray-300 bg-cover bg-center relative rounded-lg overflow-hidden" style="height:300px; background-image:url({{$post->image_url}})">
            ...
            <div class="flex flex-wrap overflow-hidden">
                <div class="w-full overflow-hidden md:w-4/6 md:pr-2 py-4">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="col-span-1 @if ($loop->first) md:col-span-2 @endif overflow-hidden">
                            ...
                            <h2 class="text-gray-900 font-serif text-2xl my-5 font-thin"><a href="/blog/{{ $post->slug }}">{{ $post->title }}</a></h2>
                            @if ($loop->first)
                                <span class="text-xs text-gray-800 font-thin block mb-5">{{ $post->created_at->format('l, jS F, Y') }}</span>
                            @endif
                            <p class="text-gray-900 font-thin tracking-wider leading-loose">{{ $post->summary }}</p>
                ...
                <div class="w-full overflow-hidden md:w-2/6 md:pl-2 py-4">
                    ...
                    <div class="ml-2 md:ml-4 mr-2">
                        ...
                        <div class="mt-10">
                            <h2 class="font-light text-xl mb-5 text-gray-900">Categories</h2>
                            <ul>
                                <li class="flex"><a href="" class="text-gray-900 font-thin font-serif text-lg py-2 block flex-1">Travel Tips</a><span class="text-gray-700 text-lg font-thin p-2">2</span></li>
                                <li class="flex"><a href="" class="text-gray-900 font-thin font-serif text-lg py-2 block flex-1">Shark Life</a><span class="text-gray-700 text-lg font-thin p-2">10</span></li>
                                <li class="flex"><a href="" class="text-gray-900 font-thin font-serif text-lg py-2 block flex-1">Inspiration</a><span class="text-gray-700 text-lg font-thin p-2">7</span></li>
                                <li class="flex"><a href="" class="text-gray-900 font-thin font-serif text-lg py-2 block flex-1">Travel Gear</a><span class="text-gray-700 text-lg font-thin p-2">4</span></li>
                            </ul>
                        </div>
                        <div class="mt-10">
                            <h2 class="font-light text-xl mb-5 text-gray-900 first">Recent Posts</h2>
                            <ul>
                                <li class="mb-3">
                                    <a href="" class="flex">
                                        <div class="w-1/3">
                                            <img class="rounded" src="https://dummyimage.com/720x400" alt="">
                                        </div>
                                        <div class="w-2/3 p-2">
                                            <h3 class="text-gray-900 font-thin font-serif mb-2">Use Travel To Make Someone Fall In Love...</h3>
                        ...
                        <div class="mt-10 bg-gray-100 rounded-sm p-5">
                            <div class="pb-6">
                                ...
                                <form action="">
                                    <input required type="text" id="name" placeholder="First Name" name="name" class="w-full bg-white border border-ash-300 focus:border-orange-400 focus:ring-2 focus:ring-orange-200 text-base outline-none text-ash-700 p-3 my-2 leading-8">
